...
#  wuth output layer we get detection of objects
colors = np.random.uniform(1, 255, size=(len(classes), 3))

# Loading image
img = cv2.imread(r"C:\Users\Nwabike\Desktop\Tech\opencv\Yolo project\image.jpg") # Enter your image name here that you want to detect
 
# Resizing the image.None refers to no fixed  state. fx and fy are width and height
img = cv2.resize(img, (800, 800)) #Optional
